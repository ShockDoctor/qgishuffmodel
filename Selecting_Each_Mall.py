...
def run_script(iface):
    ...
    # Make a copy of the huff model layer to work with so that all changes are made to copy only keeping original data
    # intact
    ...
    print "XXXX: {}".format(mall)

    # This is where you choose the mall that you want the market areas for. Currently accepts an index number,
    # which is column number in the attribute table. I.e 1 for the first column aka first mall, 2 for the second column
    # aka second mall and so forth
    qid = QInputDialog()
